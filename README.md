...
1. Создать папку dist (если нет) в корне
2. Скопировать содержимое скачанной дефолтной папки wordpress
3. В файле ./gulp/config/paths.js изменить название темы - themeName
